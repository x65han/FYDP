...
import { StyleSheet, View, Text, ActivityIndicator, TouchableHighlight, Slider, Platform } from 'react-native';
import {
...
export default class PlaylistScreen extends React.Component<Props, State> {
    ...
    public async componentWillMount() {
        ...
        const { playlist, image2text } = await RecommendationService.getRecommendation(session)

        this.setState({ image2text, playlist, hasPlaylist: true, loading: false })
    }
            ...
            <View style={styles.root}>
                {
                    this.state.loading === true ?
                        ...
                        <>
                            ...
                            <Text>
                                {this.getBoldText('Predicted Text: ')}
                                {this.state.image2text}
                            </Text>
